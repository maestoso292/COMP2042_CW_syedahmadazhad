...
public class LevelFive extends Level {
    ...
    protected LevelFive(int levelNumber, double waterBoundary) {
        ...
        add(new Log(Log.LogType.MEDIUM, 25, Section.FOUR.getY(), -1));
        add(new Log(Log.LogType.MEDIUM, 375, Section.FOUR.getY(), -1));
        ...
        add(new Log(Log.LogType.LONG, -150, Section.SEVEN.getY(), 1));
        add(new Log(Log.LogType.LONG, 300, Section.SEVEN.getY(), 1));

        add(new WetTurtle(250, Section.EIGHT.getY(), 2, true));
        add(new WetTurtle(0, Section.EIGHT.getY(), 2, true));

        add(new Log(Log.LogType.SHORT, 0, Section.NINE.getY(), -3));
        add(new Log(Log.LogType.SHORT, 400, Section.NINE.getY(), -3));

        add(new Log(Log.LogType.LONG, 350, Section.TEN.getY(), 3));
        ...
        add(new Log(Log.LogType.SHORT, 0, Section.TWELVE.getY(), 1.5));
        add(new Log(Log.LogType.SHORT, 350, Section.TWELVE.getY(), 1.5));
